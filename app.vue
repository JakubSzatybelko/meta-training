...
useHead({
  ...
  meta: [
    ...
    { hid: 'twitter:title', property: 'twitter:title', content: theming?.pageTitle || 'Machine Master' },
    { hid: 'twitter:description', property: 'twitter:description', content: theming?.metaDataDescription || '' },
    {
      hid: 'twitter:image',
